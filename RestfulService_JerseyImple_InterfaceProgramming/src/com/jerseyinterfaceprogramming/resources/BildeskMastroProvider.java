...
@Path("/mastro")
public class BildeskMastroProvider implements BildeskProvider {
	 public BildeskMastroProvider() {
	System.out.println("inside the Mastro constructor class");	
	}

	@Override
	public StreamingOutput pay(InputStream in) {
		System.out.println("inside the Mastro implementation class");
